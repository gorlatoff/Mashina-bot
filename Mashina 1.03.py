...
def update_slovnik():
    ...
    for name in dfs['suggestions'].columns:
        dfs['suggestions'][name] = dfs['suggestions'][name].fillna("___").astype(str)
...
#     return sheet[sheet[jezyk].str.contains(slovo, na=False)]
...
@bot.command(aliases = ['id', 'isv', 'isl', 'мс', 'ms', 'ru', 'be', 'uk', 'ua', 'pl', 'cs', 'cz', 'sk', 'bg', 'mk', 'sr', 'hr', 'sl', 'ру', 'бе', 'ук', 'бг', 'мк', 'ср', 'en', 'de', 'nl', 'eo' ])
